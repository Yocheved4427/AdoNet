namespace AdoNet
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string connectionString = "Data Source=DESKTOP-KTT59QQ;Initial Catalog=Production;Integrated Security=True; Trusted_Connection = True; TrustServerCertificate = True;\r\n";
